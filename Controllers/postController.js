...
export const getPosts = async(req,res,next)=>{
    try{
        ...
        //on va recupérer la liste d'amis d'un utiliser en une chaine / puis tab
        const friends = user?.friends?.toString().split(",") ?? [];
        friends.push(userId);
// req Mongo pour recherche des pub dans base 
        const searchPostQuery = {
            $or: [
              {
                //regex:chercher ou valeur descripton correspond à la chaine definie
